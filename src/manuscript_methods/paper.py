...
# This is the ordering used by the pipeline that produced the published numbers.
# `manuscript_methods.therapeutic_areas.TherapeuticAreaHierarchy` carries a different
# ordering and is not used by this pipeline (see GAPS.md).
THERAPEUTIC_AREAS = {
