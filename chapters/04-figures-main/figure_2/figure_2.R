...
# Outputs: figure_2.pdf and ../../05-figures-supplementary/extended_data/extended_figure_9.pdf
...
# Run from the repository root: tools/run_r.sh chapters/04-figures-main/figure_2/figure_2.R
data_dir <- "data/intermediate_files_refactor"
out_dir <- "chapters/04-figures-main/figure_2"


data_2a_path <- file.path(data_dir, "figure_2_a.csv")
data_2b_path <- file.path(data_dir, "figure_2_b.csv")
...
data_2c_path <- file.path(data_dir, "figure_2_c.csv")
data_2d_path <- file.path(data_dir, "figure_2_d.csv")
...
ggsave(
  file.path(out_dir, "figure_2.pdf"),
...
ggsave(
  "chapters/05-figures-supplementary/extended_data/extended_figure_9.pdf",
  plot = plot_ed9,
