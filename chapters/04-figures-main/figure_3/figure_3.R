...
# Resolve paths
# -----------------------------
# Run from the repository root: tools/run_r.sh chapters/04-figures-main/figure_3/figure_3.R
data_dir <- "data/intermediate_files_refactor"
figure_3_dir <- "chapters/04-figures-main/figure_3"

plot_a_path <- file.path(data_dir, "plot_a.csv")
plot_b_path <- file.path(data_dir, "plot_b.csv")
pleio_1_csv <- file.path(data_dir, "variant_pleiotropy_data_exploded.csv")
pleio_2_csv <- file.path(data_dir, "variant_pleiotropy_data_exploded_2.csv")
for (path in c(plot_a_path, plot_b_path, pleio_1_csv, pleio_2_csv)) {
...
# Combine and save
# -----------------------------
out_path <- file.path(figure_3_dir, "figure_3.pdf")
