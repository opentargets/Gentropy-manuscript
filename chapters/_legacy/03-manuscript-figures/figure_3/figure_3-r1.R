...
plot_a_path <- file.path(figure_3_dir, "data", "plot_a-r1.csv")
plot_b_path <- file.path(figure_3_dir, "data", "plot_b-r1.csv")
...
if (!file.exists(plot_a_path)) plot_a_path <- "data/plot_a-r1.csv"
if (!file.exists(plot_b_path)) plot_b_path <- "data/plot_b-r1.csv"
...
# Combine and save
# -----------------------------
out_path <- file.path(figure_3_dir, "figure_3_final-r1.pdf")
if (!nzchar(figure_3_dir)) out_path <- "figure_3_final-r1.pdf"
