...
# ---- Combine plots A and B side by side ----
...
# Save combined plot as png (plots A and B side by side)
ggsave("figure_2_AB.png", plot = combined_grob, width = 8.27, height = 3, dpi = 300, bg = "#ffffff00")
