...
# chapters/02-analysis-main/01_panoramic.ipynb, so this script performs no analysis of its own.
#
...
#   tools/run_r.sh chapters/05-figures-supplementary/extended_data/ed10_rare_variant_discovery.R
ed10_dir <- "chapters/05-figures-supplementary/extended_data"
input_csv <- "data/intermediate_files_refactor/rare_discovery_over_time.csv"
