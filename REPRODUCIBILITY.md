...
PASS 38 | MISMATCH 11 | BLOCKED 15 | PENDING 89

|          | id    | section   | claim                                                     | manuscript | computed | source                   |
| -------- | ----- | --------- | --------------------------------------------------------- | ---------- | -------- | ------------------------ |
| MISMATCH | R1.02 | Results 1 | publications                                              | 4250       | 7004     | panoramic.json           |
| MISMATCH | R1.03 | Results 1 | trait ontology terms                                      | 9280       | 12856    | panoramic.json           |
| MISMATCH | R1.07 | Results 1 | GWAS credible sets                                        | 789453     | 780062   | panoramic.json           |
| MISMATCH | R1.08 | Results 1 | studies with at least one CS                              | 39282      | 39253    | panoramic.json           |
| MISMATCH | R1.25 | Results 1 | protein-coding genes associated (%)                       | 77.9       | 77.7     | panoramic.json           |
| MISMATCH | R1.27 | Results 1 | disease-associated genes by 2024 (denominator)            | 8129       | 8014     | panoramic.json           |
| MISMATCH | R2.01 | Results 2 | non-redundant replicated CSs with PIP >= 0.5              | 120809     | 121490   | selective_pressures.json |
| MISMATCH | R3.04 | Results 3 | CS-protein coding gene pairs scored                       | 7066749    | 10623371 | colocalisation_l2g.json  |
